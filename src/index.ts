...
const JEFFREY_CURRIE_TRADER_UUID = "a1875d26-0b98-4a68-b7fc-e8e8f5fc0a8b";
...
const TRADER_UUID_BY_HOST: Record<string, string> = {
  ...
  "jeffreycurrie.com": JEFFREY_CURRIE_TRADER_UUID,
  "www.jeffreycurrie.com": JEFFREY_CURRIE_TRADER_UUID,
};
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (url.hostname === "www.jeffreycurrie.com") {
      return redirectWwwToApex(url, "jeffreycurrie.com");
    }
